...
const BookUpdate = ({ onSubmit, book }) => {
    ...
    return (
        <div className='w-full flex justify-center'>
            <form onSubmit={handleSubmit} className="my-10 flex flex-col w-[750px] p-8 space-y-6 bg-white rounded-lg shadow-lg ring-1 ring-blue-300">
                <h2 className="text-2xl font-semibold text-gray-800 mb-6">Editar Libro</h2>
                ...
                <div>
                    ...
                    <input id="genre" name="genre" value={form.genre} onChange={handleChange} placeholder="Descripción breve" maxLength={100} required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <input id="published" name="published" value={form.published} onChange={handleChange} placeholder="Año" required type="number"
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                </div>
                ...
                <button
                    type="submit"
                    className="w-full py-3 mt-4 bg-orange-600 text-white rounded-lg font-semibold cursor-pointer"
                >
                    Editar Libro
                </button>
            </form>
